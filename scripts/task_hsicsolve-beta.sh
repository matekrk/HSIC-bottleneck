...
run_hsicbt -cfg config/hsicsolve-beta.yaml -tt backprop  -dc synthetic -lr 0.05 -dt ${n_layers}
run_hsicbt -cfg config/hsicsolve-beta.yaml -tt hsictrain -dc synthetic -lr 0.001 -s 6 -ld 2500 -dt ${n_layers}
run_plot -t hsic-solve -dc synthetic -e pdf
...
run_plot -t hsic-solve -dc cifar10 -e pdf
run_hsicbt -cfg config/hsicsolve-beta.yaml -tt backprop  -dc synthetic -lr 0.01 -dt ${n_layers}
run_hsicbt -cfg config/hsicsolve-beta.yaml -tt hsictrain -dc synthetic -lr 0.001 -s 6 -ld 500 -dt ${n_layers}
run_plot -t hsic-solve -dc synthetic -e pdf
